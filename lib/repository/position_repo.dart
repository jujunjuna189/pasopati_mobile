...
class PositionRepo {
  PositionRepo._privateConstructor();
  static final PositionRepo instance = PositionRepo._privateConstructor();

  final _pejabatShow = Api.pejabatShow;

  Future show(Map<String, dynamic> body) async {
    try {
      final response = await http.post(Uri.parse(_pejabatShow), body: body);
